...
class="h-full text-decoration-underline text-right"
    ...
    <Dialog
ref="howToModal" v-model:visible="howToModalVisible" :draggable="false" header="How do I login?" modal
        ...
        <div class="align-items-center flex flex-column">
            ...
            <img alt="SudoSOS QR Code" src="@/assets/sudosos-qr.png"  style="width: 25rem;"/>
        </div>
    </Dialog>
</template>
