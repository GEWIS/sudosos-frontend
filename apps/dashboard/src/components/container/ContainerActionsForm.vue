<template>
  <div class="flex flex-column justify-content-between gap-2">
    <InputSpan
        ...
        :label="t('common.name')" :placeholder="t('common.name')"
    ...
    <InputSpan
        ...
        :label="t('modules.seller.productContainers.containers.public')" :placeholder="t('modules.seller.productContainers.containers.public')"
        type="boolean" :value="form.model.public.value.value"
