<template>
  <div class="flex flex-column justify-content-between gap-2">
    <InputSpan :label="$t('c_invoiceInfo.Addressee')"
               ...
               @update:value="form.model.addressee.value.value = $event"
    ...
    <InputSpan :label="$t('c_invoiceInfo.Attention')"
               ...
               @update:value="form.model.attention.value.value = $event"
    ...
    <InputSpan :label="$t('c_invoiceInfo.Street')"
               ...
               @update:value="form.model.street.value.value = $event"
    ...
    <InputSpan :label="$t('c_invoiceInfo.Postal code')"
               ...
               @update:value="form.model.postalCode.value.value = $event"
    ...
    <InputSpan :label="$t('c_invoiceInfo.City')"
               ...
               @update:value="form.model.city.value.value = $event"
    ...
    <InputSpan :label="$t('c_invoiceInfo.Country')"
               ...
               @update:value="form.model.country.value.value = $event"
...
const needsUpdate = () => {
  return props.invoice.addressee !== props.form.model.addressee.value.value ||
      props.invoice.attention !==  props.form.model.attention.value.value ||
      props.invoice.street !==  props.form.model.street.value.value ||
      props.invoice.postalCode !==  props.form.model.postalCode.value.value ||
      props.invoice.city !==  props.form.model.city.value.value ||
      props.invoice.country !==  props.form.model.country.value.value;
};
